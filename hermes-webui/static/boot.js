...
document.querySelectorAll('.suggestion').forEach(btn=>{
  btn.onclick=()=>{
    // Use the same locale as the visible label ([data-i18n] on the inner span),
    // not the fixed English data-msg — otherwise zh users see Chinese but we ship
    // English to the agent, and tooling/title heuristics diverge from manual typing.
